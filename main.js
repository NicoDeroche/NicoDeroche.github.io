...
module.exports = "<p></p>\n<h3 class=\"customFont\">Administration</h3>\n\n<br>\n<div *ngIf=\" (afAuth.user | async )?.email=='nico.deroche@gmail.com' ; then thenBlock else elseBlock\"></div>\n<ng-template #thenBlock>\n  <button class=\"btn btn-secondary\" (click)=\"logout()\">Logout</button><br><br>\n  <form #f=\"ngForm\" (ngSubmit)=\"f.form.valid && onSubmit(f);\">\n    <div class=\"form-group\">\n      <label class=\"customFont\"> <i class=\"fas fa-robot text-muted\" aria-hidden=\"true\"></i>&nbsp;<span\n          class=\"customFont\">Titre</span></label>\n      <input type=\"text\" class=\"form-control col-xs-2 customFont\" name=\"chapitre\" ngModel aria-label=\"chapitre\"\n        aria-describedby=\"basic-addon1\">\n    </div>\n\n\n    <div class=\"form-group\">\n      <label class=\"customFont\"> <i class=\"fas fa-robot text-muted\" aria-hidden=\"true\"></i>&nbsp;<span\n          class=\"customFont\">Image</span></label>\n\n      <input type=\"file\" (change)=\"detectFiles($event)\" class=\"form-control\" accept=\".jpg\">\n\n    </div>\n    <button class=\"btn btn-secondary\" type=\"submit\">Créer</button>\n\n\n  </form>\n</ng-template>\n<ng-template #elseBlock>\n\n\n  \n    Vous n'êtes pas authentifiés ou pas autorisés.<br><br>\n    <button class=\"btn btn-secondary\" (click)=\"login()\">Login</button>\n\n  \n</ng-template>\n<p></p>"
